...
namespace Ants {
    ...
    class Search {
        ...
        public delegate bool Passable(Location A);
        ...
        private Passable isPassable;
        

        public Search(IGameState gameState, Heuristic heuristic, Passable isPassable) {
                    ...
                    foreach (Direction direction in Enum.GetValues(typeof(Direction))) {
                        if (direction != Direction.None) {
                            ...
                            if ((closedSet[neighbour.Row, neighbour.Col] != null && F >= closedSet[neighbour.Row, neighbour.Col].F) ||
                                !isPassable(neighbour) || F > maxDistance)
                                continue;
